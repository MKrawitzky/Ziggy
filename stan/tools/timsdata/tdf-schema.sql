...
-- delay / timebase information, refer to table DigitizerConstants.
...
-- 'ModelType'.
-- Foreign keys
  FOREIGN KEY (Id) REFERENCES Frames (MzCalibration)
) WITHOUT ROWID;
...
-- Bruker-internal information on reference m/z calibration. For digitizer
-- delay / timebase information, refer to DigitizerConstants.
...
INSERT INTO GlobalMetadata VALUES ('SchemaVersionMajor', '4');
...
CREATE TABLE Frames (
    ...
    -- ID of the frame mz calibration for this frame, NULL if only reference calibration is available
    ...
    -- Flag indicating denoised state of Frame
    Denoised BOOLEAN CHECK (Denoised IN (0,1)) NOT NULL,
